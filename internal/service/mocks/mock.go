...
import (
	...
	models "github.com/katenester/Todo/internal/models"
)
...
func (m *MockTodoList) Update(userId, listId int, list models.TodoListInput) error {
	m.ctrl.T.Helper()
...
// Update mocks base method.
func (m *MockTodoItem) Update(userId, itemId int, item models.TodoItemInput) error {
	m.ctrl.T.Helper()
